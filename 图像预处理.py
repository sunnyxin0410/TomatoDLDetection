...
if __name__ == '__main__':
    ...
    need_aug_num = 3  # 每张图片扩增数量
    out_root_path = './datasets'  # 输出路径

    source_pic_root_path = 'VOCdevkit/VOC2007/JPEGImages'  # 存放要原始图像
    source_xml_root_path = 'VOCdevkit/VOC2007/Annotations'  # 存放原始xml
